...
default:
    ...
    return (
        <div >
          ...
          <button name='good' onClick={this.handleGood} className={css.btn}>Good</button>
          <button name='neutral'onClick={this.handleNeutral} className={css.btn}>Neutral</button>
          <button name='bad' onClick={this.handleBad} className={css.btn}>Bad</button>
          <h2>Statistics</h2>
